...
<!DOCTYPE html>
<%
    habitaciones htns = new habitaciones();
    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <div class="navbar-text"><font color="white" size="3">&nbsp;&nbsp&nbsp;&nbsp HOTEL El Lobo - Lobby</font></div>
          </div>
...
box-shadow: inset 0px 6px 7px -1px rgba(0,0,0,0.34);">
                ...
                <div class="btn-group col-sm-3">
                    <form name="peticion" action="habitaciones" method="POST">
